#!/usr//bin/python
#
# driver.py - This script tests the correctness and performance of 
#     a stuednt's transpose function. It runs ./test-trans on three 
#     different sized matrices (32x32, 64x64, and 61x67) to test 
#     the correctness and performance of the transpose function.
# 
# This file was modified from the original by Frank Jones on 11/23/18
# These changes eliminated the tests of a student's csim.c solution.
...
def main():
    ...
    #Testing the performance and correctness of the trans.c file
    # 32x32 transpose
